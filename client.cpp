...
//============================================================
    ...
    connect (pbtnSendPicture,   &QPushButton::clicked,
             this,              &Client::slotSendTextToServer
...
void Client::slotOpenFile()
{
    ...
    if (!fileName.isEmpty())
        this->currentTextName = fileName.right(fileName.size()
    ...
    QTextStream in(&file);
    this->textData = in.readAll();

}

//============================================================

void Client::slotSendTextToServer()
{
/*
